...
{	 
	...
	$message = $_POST['message'];
	 ...
	 $query = "INSERT INTO `contact`(`namecon`, `emailcon`, `subject`, `comment`) VALUES ('$name','$email','$subject','$message')";
...
<head>
    <meta charset="utf-8">
    <title>succsessfully-Registration|Now-Your dream course </title>
...
<body>
            ...
            <div class="col-lg-4 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    <h1 class="fw-bold text-primary m-0"><img src="img/logocoding.png"
                            style="width: 70px; height: 70px; margin-left: 10px;">JITU-CodingClass</h1>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Registration</h1>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <img src="img/success.png" style="width: 100px; height: 100px;">
                    <h3 class="display" style="" >Successfully</h3>
                    <h4 class="mb-4">Register Your Response</h4>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="contact.php">Go Back To Home</a>
                </div>
            </div>
        </div>
    </div>
