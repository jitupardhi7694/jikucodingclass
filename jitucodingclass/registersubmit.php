...
if (isset($_POST['register'])) {
    ...
    $query = "INSERT INTO `registration`(`firstname`, `lastname`, `email`, `password`, `confirmpassword`, `number`, `gender`, `city`, `state`, `country`) VALUES ('$FirstName','$LastName','$email','$pass','$conpass','$number','$gender','$city','$state','$country')";

    $SQL = mysqli_query($con, $query);

    if ($SQL) {
        header('location:registersubmit.php');
