...
<head>
    <meta charset="utf-8">
    <title>Contact Student || Database</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Contact Student Database</h1>
        </div>
    </div>
    <!-- Page Header End -->
                        ...
                        <table id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $res['namecon']; ?></td>
                                    <td><?php echo $res['emailcon']; ?></td>
                                    ...
                                    <td>
                                        <div class="btn" role="group" aria-label="Basic example"
                                            ...
                                            <button class=" btn btn-danger"> <a
                                                    href="deletecontact.php?id=<?php echo $res['id']; ?>"
