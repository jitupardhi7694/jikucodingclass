...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Login Now</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container">
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form method="POST" class="needs-validation" action="new_log_submit.php" novalidate>
                        <div class="row g-3">
                            <div class="col">
                                <div class="form-floating">
                                    <input type="email" autofocus name="email" id="user" class="form-control"
                                        placeholder="Your Email" required>
                                    <label for="email">Your Email</label>
                                    <div class="invalid-feedback">
                                        please proper email id
                                    </div>
                                </div>
                                <br>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <button class="btn btn-primary rounded-pill py-3 px-5" id="btn" type="submit"
                                    onclick="btn()">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
