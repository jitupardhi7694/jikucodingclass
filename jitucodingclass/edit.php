                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="firstname" class="form-control" id="name"
                                        placeholder="Your Name" value="<?php echo $firstname ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="password" name="password" class="form-control"
                                        placeholder="Your Password" value="<?php echo $pass ?>">
                            ...
                            <div class="col-6">
                                <div class="form-floating">
                                    <input class="form-control" placeholder="Country" name="country"
                                        value="<?php echo $country ?>"></input>
                                    <label for="country">Country</label>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="update"
