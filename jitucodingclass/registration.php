...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Registration Now</h1>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form method="POST" action="registersubmit.php">
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="form-floating">
                                    <input class="form-control" placeholder="State" name="state"></input>
                                    <label for="state">State</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-floating">
                                    <input class="form-control" placeholder="Country" name="country"></input>
                                    <label for="country">Country</label>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="register"
                                    type="submit">Register</button>

                                <button class="btn btn-primary rounded-pill py-3 px-5" name="reset"
    ...
    <div class="container-fluid bg-dark text-body footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        function validate() {
            ...
            if (!document.getElementById("password").value == document.getElementById("confirm_password").value) alert(
