...
<head>
    <meta charset="utf-8">
    <title>www.jikucodingclass.com</title>
...
<body>
            ...
            <div class="col-lg-4 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    <h1 class="fw-bold text-primary m-0"><img src="img/logocoding.png"
                            style="width: 50px; height: 50px; margin-right:15px; color:tomato;">JIKU-CodingClass</h1>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn navbar-active"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <a href="contact.php" class="nav-item nav-link" target="_blank">Contact Us</a>
            </div>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Creative & Innovative Programming
                                Learning</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Learn what the Industry demands
                            </h4>

                            <h1 class="display-1 text-white mb-0 animated zoomIn">Industry demands</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Take your first step towards</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">your tech career</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h5 class="mb-3">Placements Support</h5>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 id="service" class="section-title bg-white text-center text-primary px-3">Services</h6>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            ...
                            <a href="enrollform.php" target="_blank" class="btn btn-sm btn-outline-primary">Enroll
                                Course</a>
                        </a>
                    </form>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            ...
                            <h4 class="mb-0">Ethical Hacking</h4>
                            <a href="enrollform.php" target="_blank" class="btn btn-sm btn-outline-primary">Enroll
                                Course</a>
                        </a>
                    </form>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            ...
                            <h4 class="mb-0">Business Analyst</h4>
                            <a href="enrollform.php" target="_blank" class="btn btn-sm btn-outline-primary">Enroll
                                Course</a>
                        </a>
                    </form>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 id="service" class="bg-white text-center text-primary px-3">Have a Dream Company In Mind?</h6>
                <h1 class="display-6 mb-4">Meet Our 100+ Hiring Partners</h1>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/ibm.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/airmeet.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/ajio.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/bharatpe.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/byjus.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/dream11.svg" alt="">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/whitehat.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/vyapper.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/urban.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/swiggy.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/smallcase.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="">
                        <a class="service-item d-block rounded text-center h-100 p-4" href="">
                            <img class="img-fluid rounded mb-4" src="clientImage/sharechat.svg" alt="">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-6 mb-4">Connect with a growing community of learners</h1>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="contact.php" target="_blank">Contact Us</a>
