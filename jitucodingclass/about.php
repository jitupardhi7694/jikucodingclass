...
<head>
    <meta charset="utf-8">
    <title>About|JIKU CodingClass-build your programming skills</title>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn navbar-active"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <a href="contact.php" target="_blank" class="nav-item nav-link">Contact Us</a>
            </div>
            <a href="registration.php" class="btn btn-sm btn-outline-light  ">Registration</a>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="img-border">
                        <img class="img-fluid" src="img/aboutNew.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-primary pe-3">About Us</h6>
                        <h1 class="display-6 mb-4"> The JIKU CodingClass</h1>
                        <p>JIKU CodingClass is a platform to learn and develop skills that you need for your best Tech
                            career. We boost up your skills and prepare you for your dream job. </p>
                        <p class="mb-4">We are dedicated to build and structure your tech career for the dream companies
                            worldwide based on your skills, eligibility, preferences and work hard with you till you get
                            into one of yours.</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-6 mb-4">We Are A Creative Team For Your Dream Courses</h1>
            </div>
            <div class="row g-2 justify-content-lg-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/JITU.jpg" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Jitendra Pardhi</h5>
                                <!-- <span>FULL STACK WEB DEVELOPER</span> -->
                            </div>
                            <div class="team-social team-text">
                                <!-- <h5>Jitendra Pardhi</h5> -->
                                <span>FULL STACK WEB DEVELOPER</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="img/kunal.jpeg" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Kunal Kodarlikar</h5>
