...
<head>
    <meta charset="utf-8">
    <title>Database-table|Now-Your dream course </title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn navbar-active"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="logout.php" name="logout" class="btn btn-sm btn-outline-light">Logout</a>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-4 text-white animated slideInDown mb-3">Registration Database</h1>
        </div>
    </div>
    <!-- Page Header End -->
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example"
                                            ...
                                            <button class="btn-danger btn btn-sm"> <a
                                                    href="edit.php?id=<?php echo $res['id']; ?>"
                                                    class="text-white">Edit</a> </button>

                                            <button class="btn-danger btn btn-sm"> <a
                                                    href="databasedelete.php?id=<?php echo $res['id']; ?>"
